...
@section('container')
    ...
    <div class="data-box1">
        ...
        <div
            ...
            <h2 class="fw-bold px-3 py-2 border-start border-4 border-primary">Insertion Sort</h2>
        </div>
        @include('dashboard.panggil.tujuan2')

        <div
            class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border rounded shadow-lg bg-light">
            <h4 class="fw-bold border-start border-4 border-warning">📝 1. Apa Itu Insertion Sort?</h4>
        </div>
        ...
        <p>Insertion Sort adalah salah satu algoritma yang digunakan untuk permasalahan pengurutan dalam list (daftar
            objek). Sesuai namanya, insertion sort mengurutkan sebuah list dengan cara menyisipkan elemen satu per satu
            sesuai dengan urutan besar kecilnya elemen hingga semua elemen menjadi list yang terurut. Misalnya, dalam kasus
            mengurutkan elemen list dari yang terkecil hingga terbesar (ascending), tahap pertama ialah kita akan membaca
        ...
        <div class="list">
            <p>Berikut langkah-langkah yang harus diperhatikan pada metode Insertion Sort.
            <ol>
        ...
        <div
            class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border rounded shadow-lg bg-light">
            <h4 class="fw-bold border-start border-4 border-warning">💡 2. Langkah-Langkah Iterasi Dalam Insertion Sort</h4>
        </div>
        <p>Terdapat sebuah deret bilangan seperti gambar dibawah ini. Gunakan
            algoritma insertion sort untuk mengurutkan bilangan ini dari terkecil ke terbesar.
            <img src="{{ asset('img/insertion/insertion.png') }}" class="img">
        </p>

        <h5 class="fw-bold">Berikut untuk memahami Langkah-langkah iterasi insertion sort dibawah ini: <br><br>1. Proses
            Iterasi Pertama</h5>
        ...
        <h5><b>Hasil Pengurutan insertion Sort</b></h5>
