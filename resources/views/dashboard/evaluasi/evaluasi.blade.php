    ...
    <nav class="navbar text-white sticky-top">
        <div class="container">
            ...
            <div class="d-flex align-items-stretch justify-content-start ">
                <h2 class="m-0"><span class="badge text-bg-warning me-3" id="waktu-durasi">60:00</span></h2>
        ...
        <div class="row mt-3">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Hasil {{ $materi }}</h5>
            ...
            <script>
                ...
                if (isNaN(remainingDuration) || remainingDuration <= 0) {
                    remainingDuration = 60 * 60; // mundur 60 menit
                }
                ...
                submitBtn.addEventListener('click', function() {
                    swal.fire({
                        ...
                        text: "Periksa kembali jawaban anda sebelum mengakhiri evaluasi!",
                        icon: "warning",
                        showCancelButton: true,
