...
<body>
    <div class="container" id="bubbleContainerV9">
        ...
        <div class="control-buttons">
            <button id="btnTukarV9">Tukar</button>
            <button id="btnTidakTukarV9">Tidak Ditukar</button>
            <button id="btnResetV9" style="background-color: #dc3545;">Reset</button>
        </div>

        <div id="bubbleStatusV9" class="text-center mt-3"></div>
    </div>
    ...
    <script>
        function BubbleSortMiniV2() {
            let i9 = 0;
            let j9 = 0;
            const dataAwalV9 = [2, 3, 4, 8, 9];
            let dataSekarangV9 = [...dataAwalV9];

            const rowsContainer = document.getElementById("bubbleRowsV9");
            const btnTukar = document.getElementById("btnTukarV9");
            const btnTidakTukar = document.getElementById("btnTidakTukarV9");
            const btnReset = document.getElementById("btnResetV9");
            const status = document.getElementById("bubbleStatusV9");
            ...
            function updateInfoIterasi() {
                const info = document.getElementById("bubbleIterasiV9");
                info.innerText = `Iterasi ke-${i9 + 4}`;
            }
            ...
            function updateButtonState() {
                ...
                const kiri = dataSekarangV9[j9];
                const kanan = dataSekarangV9[j9 + 1];
            ...
            btnTukar.addEventListener("click", () => {
                ...
                const box1 = rowBoxes[j9];
                const box2 = rowBoxes[j9 + 1];
                ...
                setTimeout(() => {
                    const temp = dataSekarangV9[j9];
                    dataSekarangV9[j9] = dataSekarangV9[j9 + 1];
                    dataSekarangV9[j9 + 1] = temp;

                    box1.classList.remove("swap-animate-right");
                    box2.classList.remove("swap-animate-left");

                    renderRow(dataSekarangV9, null, "Hasil Pertukaran");
