...
<head>
    <meta charset="UTF-8">
    <title>Kuis Selection Sort</title>
        ...
        <div class="container">
            <div class="left-box">
                ...
                <div class="button-group">
                    <button onclick="window.location.href='{{ url('/dashboard/selection') }}'" class="back">Kembali Ke
                        Materi</button>
                    <button onclick="window.location.href='{{ url('/dashboard/kuis/IsiKuisSelection') }}'"
