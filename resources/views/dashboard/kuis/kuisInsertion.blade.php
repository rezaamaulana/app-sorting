        ...
        <div class="container">
            <div class="left-box">
                ...
                <div class="button-group">
                    <button onclick="window.location.href='{{ url('/dashboard/insertion') }}'" class="back">Kembali Ke
                        Materi</button>
                    <button onclick="window.location.href='{{ url('/dashboard/kuis/IsiKuisInsertion') }}'"
