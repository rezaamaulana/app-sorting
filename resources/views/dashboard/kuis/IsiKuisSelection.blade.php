...
<body>
    ...
    <div class="container">
        <div class="row mt-3">
            ...
            <script>
                ...
                function submit() {
                    ...
                    if (nilai > 70) {
                        localStorage.setItem("nilaiKuis3", nilai);
                    }
        ...
        `
                    ...
                    footer += `<a href="/dashboard/selection"  class="btn btn-secondary">Kembali ke Materi!</a>`
                    if (nilai >= {{ $kkmValue }}) {
                        footer += `  <a href="/dashboard/evaluasi/evaluasiAwal"  class="btn btn-primary">Materi Selanjutnya!</a>`
                    }
