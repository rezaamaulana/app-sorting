...
<body>
    ...
    <div class="container">
        <div class="row mt-3">
            ...
            <script>
                ...
                if (isNaN(remainingDuration) || remainingDuration <= 0) {
                    remainingDuration = 60 * 20; // waktu mundur 20 menit
                }
                ...
                stopTest.addEventListener("click", () => {
                    swal.fire({
                        ...
                        if (willSubmit) {
                            window.location.href = "/dashboard/bubble"
                        }
                    });
                })
                ...
                function submit() {
                    ...
                    if (nilai > 70) {
                        localStorage.setItem("nilaiKuis1", nilai);
                    }
        ...
        `
                    ...
                    footer += `<a href="/dashboard/bubble"  class="btn btn-secondary">Kembali ke Materi!</a>`
                    if (nilai >= {{ $kkmValue }}) {
                        footer += `  <a href="/dashboard/insertion"  class="btn btn-primary">Materi Selanjutnya!</a>`
                    }
