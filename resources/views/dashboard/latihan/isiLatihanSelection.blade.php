...
<head>
    <meta charset="UTF-8">
    <title>Latihan Selection Sort Interaktif</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-9" id="container-soal">
                <section id="soal-1">
                    <x-soal-latihanSelection :nomor="1" gambarSoal="img/selection/latihan/soal1/soal1.png"
                        :gambarIterasi="[
                            'iterasi1' => 'img/selection/latihan/soal1/iterasi1.png',
                            'iterasi2' => 'img/selection/latihan/soal1/iterasi2.png',
                            'iterasi3' => 'img/selection/latihan/soal1/iterasi3.png',
                        ]" :jawabanbenar="[
                            1 => 'iterasi1',
                            2 => 'iterasi2',
                            3 => 'iterasi3',
                ...
                <section id="soal-2">
                    <x-soal-latihanSelection1 :nomor="2" gambarSoal="img/selection/latihan/soal2/soal2.png"
                        :gambarIterasi="[
                            'iterasi1' => 'img/selection/latihan/soal2/iterasi1.png',
                            'iterasi2' => 'img/selection/latihan/soal2/iterasi2.png',
                            'iterasi3' => 'img/selection/latihan/soal2/iterasi3.png',
                            'iterasi4' => 'img/selection/latihan/soal2/iterasi4.png',
                        ]" :jawabanbenar="[
                            1 => 'iterasi1',
                            2 => 'iterasi2',
                            3 => 'iterasi3',
                ...
                <section id="soal-3">
                    <x-soal-latihanSelection1 :nomor="3" gambarSoal="img/selection/latihan/soal3/soal3.png"
                        :gambarIterasi="[
                            'iterasi1' => 'img/selection/latihan/soal3/iterasi1.png',
                            'iterasi2' => 'img/selection/latihan/soal3/iterasi2.png',
                            'iterasi3' => 'img/selection/latihan/soal3/iterasi3.png',
                            'iterasi4' => 'img/selection/latihan/soal3/iterasi4.png',
                        ]" :jawabanbenar="[
                            1 => 'iterasi1',
                            2 => 'iterasi2',
                            3 => 'iterasi3',
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <div class="modal-footer">
                        <button onclick="window.location.href='{{ url('/dashboard/selection') }}'"
