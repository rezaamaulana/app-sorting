...
<head>
    <meta charset="UTF-8">
    <title>Latihan Bubble Sort</title>
            ...
            <div class="left-box">
                ...
                <div class="data-box">
                    <ol>
                        ...
                        <li>Untuk mengurutkannya, kamu harus melakukan serangkaian pertukaran bubble sort yang telah
                            dipelajari.</li>
            ...
            <div class="right-box">
                ...
                <div class="instructions">
                    ...
                    <div class="button-group">
                        <button onclick="window.location.href='{{ url('/dashboard/bubble') }}'" class="back">Kembali
                            Ke Materi</button>
                        <button onclick="window.location.href='{{ url('/dashboard/latihan/isiLatihanBubble') }}'"
                            class="start">Mulai Latihan</button>
                    </div>
                </div>
            </div>
    </main>
