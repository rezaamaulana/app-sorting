            ...
            <div class="left-box">
                ...
                <div class="data-box">
                    <ol>
                        ...
                        <li>Untuk mengurutkannya, kamu harus melakukan serangkaian pertukaran selection sort yang telah
                            dipelajari. </li>
            ...
            <div class="right-box">
                ...
                <div class="instructions">
                    ...
                    <div class="button-group">
                        ...
                        <button onclick="window.location.href='{{ url('/dashboard/latihan/isiLatihanSelection') }}'"
                            class="start">Mulai
                            Latihan</button>
                    </div>
                </div>
