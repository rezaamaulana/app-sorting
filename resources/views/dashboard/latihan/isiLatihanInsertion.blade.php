...
<head>
    <meta charset="UTF-8">
    <title>Latihan Insertion Sort Interaktif</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-9" id="container-soal">
                <section id="soal-1">
                    <x-soal-latihanInsertion :nomor="1" gambarSoal="img/insertion/latihan/soal1/soal1.png"
                        :gambarIterasi="[
                            'iterasi1' => 'img/insertion/latihan/soal1/iterasi1.png',
                            'iterasi2' => 'img/insertion/latihan/soal1/iterasi2.png',
                            'iterasi3' => 'img/insertion/latihan/soal1/iterasi3.png',
                        ]" :jawabanbenar="[
                            1 => 'iterasi1',
                            2 => 'iterasi2',
                            3 => 'iterasi3',
                ...
                <section id="soal-2">
                    <x-soal-latihanInsertion :nomor="2" gambarSoal="img/insertion/latihan/soal2/soal2.png"
                        :gambarIterasi="[
                            'iterasi1' => 'img/insertion/latihan/soal2/iterasi1.png',
                            'iterasi2' => 'img/insertion/latihan/soal2/iterasi2.png',
                            'iterasi3' => 'img/insertion/latihan/soal2/iterasi3.png',
                        ]" :jawabanbenar="[
                            1 => 'iterasi1',
                            2 => 'iterasi2',
                            3 => 'iterasi3',
                ...
                <section id="soal-3">
                    <x-soal-latihanInsertion1 :nomor="3" gambarSoal="img/insertion/latihan/soal3/soal3.png"
                        :gambarIterasi="[
                            'iterasi1' => 'img/insertion/latihan/soal3/iterasi1.png',
                            'iterasi2' => 'img/insertion/latihan/soal3/iterasi2.png',
                            'iterasi3' => 'img/insertion/latihan/soal3/iterasi3.png',
                            'iterasi4' => 'img/insertion/latihan/soal3/iterasi4.png',
                        ]" :jawabanbenar="[
                            1 => 'iterasi1',
                            2 => 'iterasi2',
                            3 => 'iterasi3',
